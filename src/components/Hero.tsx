        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 font-cairo leading-relaxed">
              الشفاء بالقرآن الكريم والسنة النبوية المطهرة
            </p>
          </div>
          ...
          <div className="mb-12 animate-slide-up">
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              منصة متخصصة في الرقية الشرعية والعلاج بالقرآن الكريم، نقدم لك الإرشاد والدعم الروحي 
              من خلال راقي معتمد وخبير في العلاج الإسلامي
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 animate-slide-up">
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-islamic-green-100">
              ...
              <h3 className="text-xl font-semibold text-islamic-green-800 mb-2">رقية شرعية معتمدة</h3>
              <p className="text-gray-600">وفقاً للقرآن والسنة النبوية</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-islamic-gold-100">
              ...
              <h3 className="text-xl font-semibold text-islamic-green-800 mb-2">علاج شامل</h3>
              <p className="text-gray-600">للروح والنفس والجسد</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-islamic-green-100">
              <Star className="w-12 h-12 text-islamic-green-600 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-islamic-green-800 mb-2">خبرة واعتماد</h3>
              <p className="text-gray-600">سنوات من الممارسة والتخصص</p>
            </div>
          </div>
